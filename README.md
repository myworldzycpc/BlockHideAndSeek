...
2. Download the latest mod JAR `blockhas-1.2-1.12.2.jar` from the [Releases](https://github.com/myworldzycpc/BlockHideAndSeek/releases) page.
...
2. 从 [Releases](https://github.com/myworldzycpc/BlockHideAndSeek/releases) 下载模组最新 jar 文件 `blockhas-1.2-1.12.2.jar`
