...
public class ItemBeSpectator extends Item implements IHasModel {

    public ItemBeSpectator() {

        setTranslationKey("be_spectator");
        setRegistryName("be_spectator");
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
            ...
            PlayingWorldSavedData.getGlobal(worldIn).getPlayer(playerIn.getUniqueID()).setStatus(BlockHasPlayer.Status.VISITOR);
